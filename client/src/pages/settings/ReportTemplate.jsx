...
const sampleDummyRows = {
  ...
  application: [
    { name: 'Empower', manufacturer: 'Waters', versionNo: '3.0', oemContact: '123', status: 'ACTIVE', facilityName: 'Plant A', roles: 'Admin', groups: 'G1', adminGroups: 'IT' },
  ],
  instrument: [
    { make: 'Waters', model: 'HPLC', serialNumber: 'SN123', oemDetails: '{}', status: 'ACTIVE', applicationName: 'Empower', facilityName: 'Plant A', currentLocation: 'Lab1', connectedComputers: 'PC1' },
  ],
  computer: [
    { computerMakeModel: 'Dell Optiplex', serialNumber: 'SNPC', ipAddress: '192.168.1.1', status: 'ACTIVE', facilityName: 'Plant A', connectedApplications: 'Empower', connectedInstruments: 'HPLC' },
  ],
  audit: [
